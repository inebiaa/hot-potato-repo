...
export default function AccountTab(p: AccountTabProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        <h3 className="mb-2 text-sm font-semibold text-foreground">{t('safety.blocked.title')}</h3>
        {blockedLoading ? (
          <p className="text-sm text-muted-foreground">{t('safety.blocked.loading')}</p>
        ) : blockedUsers.length === 0 ? (
          <p className="text-sm text-muted-foreground">{t('safety.blocked.empty')}</p>
        ) : (
      ...
      <section className="rounded-lg border border-destructive/30 bg-destructive/5 p-4">
        <h3 className="mb-2 text-sm font-semibold text-destructive">{t('safety.delete.title')}</h3>
        <p className="mb-4 text-sm text-muted-foreground">{t('safety.delete.body')}</p>
