...
import { Button, Input, Label, formErrorClass, formSuccessClass, typeCallout } from '../components/ui';
...
export default function ResetPasswordPage() {
 ...
 <h1 className="mb-6 type-title text-foreground">{t('auth.reset.title')}</h1>
 ...
 <p className={formSuccessClass}>{t('auth.reset.success')}</p>
 ) : (
